  ...
  return (
    <div className="p-6 ">
      ...
      <h2 className="text-[24px] font-[700] mb-6 mt-[24px] md:mt-[0px]">
        Manage Access to Specific Projects or Control folders
      </h2>
      ...
      {/* Filter Dropdown */}
      {isFilterOpen && (
        <div className="absolute right-[12%] md:right-[2%] mt-[-130px] md:mt-2 w-64 md:w-[329px] bg-white rounded-lg md:rounded-3xl shadow-lg p-4 md:p-8 z-50">
          ...
          <div className="md:mt-[30px] flex items-center justify-center gap-2 md:gap-6">
        ...
        <table className="w-full table-auto border-collapse  border-gray-300 text-xs md:text-[16px]">
          <thead>
            <tr className="text-white">
              <th className="w-[46px] text-center z-0">
                <div className="bg-black mr-2 mb-1 w-full h-12 md:h-full px-3 py-2 flex items-center justify-center">
                  <input
                    type="checkbox"
                    name=""
                    id=""
          ...
          {userData?.map((user, i) => (
            <tbody key={i}>
              <tr className="h-12 md:h-full">
                {/* User Name */}
                <td className="h-12">
                  <div className="px-3 py-2 w-full flex flex-col md:flex-row items-center justify-center bg-white relative z-0 h-full">
                    <span
                      className={`relative inline-block w-6 h-6 rounded transition-all cursor-pointer ${
                ...
                <td className="h-12">
                  <div className="bg-white py-3 h-full flex items-center">
                    <p className="mx-3">{user?.controls_created}</p>
                  </div>
                </td>
                ...
                <td className="h-12">
                  <div className="bg-white py-3 h-full flex items-center">
                    <p className="mx-3">{user?.project_name}</p>
                  </div>
                </td>
